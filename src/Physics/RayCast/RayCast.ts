...
export class Ray {
  ...
  public Cast(bound: Boundry): false | FlatVec {
    const x1 = bound.GetStart().X;
    const y1 = bound.GetStart().Y;
    const x2 = bound.GetEnd().X;
    const y2 = bound.GetEnd().Y;
  ...
  public CastWithLength(bound: Boundry): false | FlatVec {
    const x1 = bound.GetStartX();
    const y1 = bound.GetStartY();
    const x2 = bound.GetEndX();
    const y2 = bound.GetEndY();
    const x3 = this.Position.X;
    const y3 = this.Position.Y;
    const x4 = this.End.X;
    const y4 = this.End.Y;
